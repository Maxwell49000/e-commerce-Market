<div class="main-content">
            ...
            <?php foreach ($produits as $produit): ?>
                <div class="product-card">
                    ...
                    <div class="product-info">
                        ...
                        <a href="index.php?controller=Produit&action=show&id=<?= htmlspecialchars($produit['id_produit']) ?>" class="btn">Voir plus</a>
                    </div>
                </div>
            <?php endforeach; ?>
        </div>
    ...
    <a href="index.php?controller=Produit&action=getProducts">Retour à la liste des produits</a>
</div>